...
const commonOverlapping = 'absolute min-h-[481px] min-w-[2000px] animate-overlapping translate-x-[1200px] z-20'

export const overlapping = {
  secondLine: `${commonOverlapping} bottom-[382px]`,
  thirdLine: `${commonOverlapping} bottom-[268px]`,
  fourthLine: `${commonOverlapping} bottom-[154px]`,
};
...
export const tileLastClassname = {
  ...
  verboseText: 'flex flex-col uppercase [&_p]:font-extrabold [&_p]:text-black [&_p]:text-[137px] [&_p]:leading-[104px] [&_span]:text-vermilion [&_svg]:mb-[110px] [&_svg]:fill-white z-10',
